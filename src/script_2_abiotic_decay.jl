# ==============================================================================
# SCRIPT 2: ABIOTIC DECAY (K_ABIOTIC) MASTER DREDGE
...
function main()
    println("Starting Script 2: Abiotic K Mega-Dredge (Biophysically-Filtered)...")
    ...
    plot_results(avg_results, winning_obj, dat, "dashboard_abiotic_decay.png")
end
