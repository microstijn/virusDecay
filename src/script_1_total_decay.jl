# ==============================================================================
# SCRIPT 1: TOTAL DECAY (K_TOTAL) MASTER DREDGE
...
function main()
    println("Starting Script 1: Total K Mega-Dredge (Biophysically-Filtered)...")
    ...
    plot_results(avg_results, winning_obj, dat, "dashboard_total_decay.png")
end
